...
wInstaller is licensed under **PolyForm Noncommercial 1.0.0**, with an
additional noncommercial-copyleft term described below. Together these are
referred to as the "wInstaller Noncommercial License."

If you want to use wInstaller commercially, see
[COMMERCIAL-LICENSE.md](COMMERCIAL-LICENSE.md) — you're welcome to ask.
...
## Additional Terms (wInstaller Noncommercial Copyleft Addendum)

The following terms are added by the wInstaller project on top of the PolyForm
Noncommercial License 1.0.0 above. Where the addendum and the PolyForm text
conflict, the addendum controls.

### 1. Noncommercial Copyleft on Forks and Derivatives

If you distribute a fork, derivative work, or modified version of the
software (a "Derivative"), you must:

- License the Derivative, in its entirety, under this same wInstaller
  Noncommercial License (PolyForm Noncommercial 1.0.0 plus this Additional
  Terms addendum) — you may not relicense a Derivative under a permissive,
  commercial, or otherwise less restrictive license.
- Include this `LICENSE.md` file, unmodified, alongside the Derivative.
- Clearly document, in the Derivative's own README or NOTICE, that it is based
  on wInstaller and is licensed under these same terms.

This requirement exists so that anyone downstream of a fork gets the same
noncommercial guarantee the original project's users get — it cannot be
stripped out by a single fork in the chain.

### 2. Commercial Use

"Commercial use" means any use of the software, or a Derivative of it,
primarily intended for or directed toward commercial advantage or monetary
compensation. If you want to use wInstaller (or a Derivative) commercially,
you need a separate commercial license — see
[COMMERCIAL-LICENSE.md](COMMERCIAL-LICENSE.md) for how to request one.

### 3. Contact

For commercial licensing inquiries, contact **pedrohbrito@me.com**.

---

Copyright (c) wInstaller contributors. All rights not expressly granted above
are reserved.
